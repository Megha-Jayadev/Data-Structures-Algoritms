...
//        -----------------------------------------------------------
        ...
        int pEle=0; int sEle=B;
        while(sEle >= 0 && pEle < n){
            int sum = 0;
            if(pEle==0){
                sum = A.get(n - 1) - (sEle < n ? A.get(n - 1 - sEle) : 0);
            } else {
                sum = A.get(pEle) + (sEle < n ? (A.get(n - 1) - A.get(n - 1 - sEle)) : 0);
            }
